  ...
  return [
    {
      ...
      description: "stop driving and diagnose — a real cam/crank correlation fault can mean a stretched or skipped timing chain, and continuing to run risks catastrophic valve/piston contact",
      impact: 0.85,
      confidence: 0.7,
      infoGain: 0.1,
      cost: 0.4,
    ...
    },
    {
      ...
      description: "inspect camshaft/crankshaft position sensor connectors and wiring for damage or corrosion before assuming a mechanical timing fault",
      impact: 0.3,
      confidence: 0.7,
      infoGain: 0.8,
      cost: 0.1,
    ...
    },
    {
      ...
      description: "pull the timing cover access point and verify cam-to-crank timing marks/alignment directly",
      impact: 0.7,
      confidence: 0.7,
      infoGain: 0.9,
      cost: 0.3,
    ...
    },
    {
      ...
      description: "inspect the timing chain tensioner and guides for wear if timing marks confirm chain stretch",
      impact: 0.6,
      confidence: 0.6,
      infoGain: 0.7,
      cost: 0.4,
...
function draft(vehicle: VehicleView): FramingResult {
  return {
    ...
    statement: {
      ...
      whyItMatters: "a real timing fault risks catastrophic engine damage if driven; a sensor fault is comparatively cheap",
      urgency: "high",
    },
    gapType: "causal",
    desiredState: {
      successCriteria: "cam/crank correlation DTC does not return and timing is confirmed within spec",
...
export const camCrankCorrelationCartridge: Cartridge = {
  ...
  perception: [{ dtcConcept: "CamCrankCorrelation", concept: "CamCrankCorrelation", as: "symptom", slot: "cam-crank-correlation" }],
